"""
Django settings for VayLares project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'clothes.context_processors.fav',
            ],
        },
    },
]

WSGI_APPLICATION = 'VayLares.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.path.join(BASE_DIR, 'vaylares_cache'),
    }
}
